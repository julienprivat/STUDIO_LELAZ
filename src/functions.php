...
class WPBoilerplateSite extends TimberSite {
	...
	function add_to_context( $context ) {
		...
		$context['options'] = Timber::get_posts($args);
...
function restructure_imgs($content) {
	...
	$pattern2 = "/<iframe(.*?)src=('|\")(.*?)(|\")(.*?)>/i";

	$replacement = '<img$1data-src=$2$3.$4$5" title="'.$post->post_title.'" class="fs-img">';
	$replacement2 = '<iframe$1data-src=$4$5" title="'.$post->post_title.'" class="fs-vid">';
